...
class GameSceneCongratulations208 extends GameSceneCongratulationsBase {
  PShader sd;
  ...
  @Override void setup() {
    ...
    sd = loadShader("data/208/Shadertoy.glsl");
    sd.set("iResolution", (float)width, (float)height, 0.0f);
    sd.set("iChannel0", loadImage("data/208/iChannel0.png"));
  }
  @Override void draw() {
