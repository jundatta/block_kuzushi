...
class GameSceneCongratulations209 extends GameSceneCongratulationsBase {
  PShader sd;
  ...
  @Override void setup() {
    ...
    sd = loadShader("data/209/Shadertoy.glsl");
    sd.set("iResolution", (float)width, (float)height, 0.0f);
    sd.set("iChannel0", loadImage("data/209/iChannel0.jpg"));
  }
  @Override void draw() {
