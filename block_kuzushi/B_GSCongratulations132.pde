...
// こちらがオリジナルです。
// 【作者】fotflaさん
// 【作品名】1tweetKaleidoscope
// https://neort.io/art/bqbfmdk3p9f6qoqnnk5g
//

class GameSceneCongratulations132 extends GameSceneCongratulationsBase {
  PShader sd;
  ...
  @Override void setup() {
    ...
    noStroke();
    sd = loadShader("data/132/neort.glsl");
