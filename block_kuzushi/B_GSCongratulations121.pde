...
// こちらがオリジナルです。
// 【作者】Liam Eganさん
// 【作品名】Naughts and Crosses 2
// https://neort.io/art/bigg4pk3p9f3vpbp9kq0
//

class GameSceneCongratulations121 extends GameSceneCongratulationsBase {
  PShader sd;
  ...
  @Override void setup() {
    ...
    noStroke();
    sd = loadShader("data/121/neort.glsl");
