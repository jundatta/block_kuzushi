...
// こちらがオリジナルです。
// 【作者】TimelordQさん
// 【作品名】TimelordQ's Matrix Rain v1.0
// https://www.shadertoy.com/view/NlcGz2
//

class GameSceneCongratulations105 extends GameSceneCongratulationsBase {
  PShader sd;
  ...
  @Override void setup() {
    ...
    noStroke();
    sd = loadShader("data/105/Shadertoy.glsl");
