...
// こちらがオリジナルです。
// 【作者】かねたさん
// 【作品名】Magatsu Loading Screen
// https://neort.io/art/bivkmdk3p9f9psc9oq10
//

class GameSceneCongratulations133 extends GameSceneCongratulationsBase {
  PShader sd;
  ...
  @Override void setup() {
    ...
    noStroke();
    sd = loadShader("data/133/neort.glsl");
