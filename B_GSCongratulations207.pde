...
class GameSceneCongratulations207 extends GameSceneCongratulationsBase {
  PShader sd;
  ...
  @Override void setup() {
    ...
    sd = loadShader("data/207/Shadertoy.glsl");
    sd.set("iResolution", (float)width, (float)height, 0.0f);
    sd.set("iChannel0", loadImage("data/207/iChannel0.jpg"));
  }
  @Override void draw() {
