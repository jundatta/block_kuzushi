...
class GameSceneCongratulations181 extends GameSceneCongratulationsBase {
  PShader sd;
  ...
  @Override void setup() {
    ...
    noStroke();
    sd = loadShader("data/181/Shadertoy.glsl");
    sd.set("iResolution", (float)width, (float)height);
    sd.set("iChannel1", loadImage("data/181/Nyancat.png"));
  }
  @Override void draw() {
