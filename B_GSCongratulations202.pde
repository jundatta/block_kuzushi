...
class GameSceneCongratulations202 extends GameSceneCongratulationsBase {
  PShader sd;
  PShader bfA;
  ...
  @Override void setup() {
    ...
    sd = loadShader("data/202/Shadertoy.glsl");
    ...
    bfA = loadShader("data/202/BufferA.glsl");
    bfA.set("iResolution", (float)width, (float)height);
    bfA.set("iChannel0", loadImage("data/202/iChannel0.png"));
    bfA.set("iChannel1", loadImage("data/202/iChannel1.jpg"));
    bfA.set("iChannel2", loadImage("data/202/iChannel2.jpg"));
  }
  @Override void draw() {
